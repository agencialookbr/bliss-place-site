export function WhatsAppFab() {
  return (
    <a
      href="https://wa.me/5561991868113"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Conversar no WhatsApp"
      className="bliss-fab fixed bottom-5 right-5 z-[999] flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_8px_24px_rgba(37,211,102,0.45)] hover:scale-110 transition-transform duration-300"
    >
      <svg width="32" height="32" viewBox="0 0 448 512" fill="currentColor" className="text-white">
